    ...
    n = {
      ...
      1569: (e, t, n) => {
        ...
        const o = function (e) {
          ...
          s = function () {
            const e = "//ssl.p.jwpcdn.com/player/v/8.26.9";
        ...
        const g = (e) =>
          ...
          v = (e) => {
            const t = "file:" === window.location.protocol ? "https:" : "",
              n = {
                bidding: "//ssl.p.jwpcdn.com/player/v/8.26.9/bidding.js",
                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.26.9/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/v/8.26.9/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/v/8.26.9/vast.js",
                googima: "//ssl.p.jwpcdn.com/player/v/8.26.9/googima.js",
                freewheel: "//ssl.p.jwpcdn.com/player/v/8.26.9/freewheel.js",
                gapro: "//ssl.p.jwpcdn.com/player/v/8.26.9/gapro.js",
                interactive:
                  "//ssl.p.jwpcdn.com/player/v/8.26.9/interactive.js",
              }[e];
            return n ? t + n : "";
          },
          b = (e, t, n) => {
        ...
        const O = (e) => {
          ...
          S = function (e) {
            ...
            if (
              (e
                ? "string" == typeof e
                  ? ((t = O(e)), t || (n = document.getElementById(e)))
                  : "number" == typeof e
                  ? (t = s.Z[e])
                  : e.nodeType &&
                    ((n = e),
                    (t = O(n.id || n.getAttribute("data-jwplayer-id"))))
                : (t = s.Z[0]),
              t)
            )
              return t;
        ...
        const $ = /^(?:on(?:ce)?|off|trigger)$/,
          ...
          U = (e, t, n, r, i) =>
            function (...o) {
              ...
              if ((c || a.push([n, s]), l)) return z(t, a), t[n].apply(e, o);
              ((e, t) => {
                const n = {
                  reason:
                    "play" !== e && "seek" !== e && "pause" !== e && (0, D.C)()
                      ? "interaction"
                      : "external",
                };
                switch (e) {
          ...
          G = function (e) {
            const t = {};
            V(this, e, e, t), V(this, e, x.prototype, t);
          },
          W = window;
        Object.assign(T, N);
        const K = function (e) {
          const t = T(e);
          return t.uniqueId ? t._publicApi || (t._publicApi = new G(t)) : t;
        };
        Object.assign(K, N),
          E(K),
          "function" == typeof W.define &&
            W.define.amd &&
            W.define([], function () {
              return K;
            });
        let Q = K;
        W.jwplayer && (Q = W.jwplayer);
        const X = Q;
      },
      3487: (e, t, n) => {
        "use strict";
      ...
      7010: (e, t, n) => {
        ...
        const r = function (e, t) {
          return e.location !== e.parent.location && /isAMP/.test(t);
        };
        function i() {
...
var jwDefaults = {
  ...
  displaytitle: false,
  height: 270,
  key: "gGwF3RgrPWlqOQRBE+OIrzqPGzZ2Nt7j+/y1c5BkC4T0TPukZOBebZziCLs=",
  ph: 1,
  pid: "7sjHar0d",
  preload: "metadata",
  repeat: false,
